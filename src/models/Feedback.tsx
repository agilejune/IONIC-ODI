...
export interface Feedback_Data {
  ...
  No: string, //1,
  Reason: string, //Jumlah KL kurang,
  Respon: string, //Respon: Admin Padalarang \nPesan: baik segera kami TL,
...
export interface FeedbackOptionChild extends FeedbackOption {
  child: FeedbackOption[]
}

export interface FeedbackOptionAll {
  code: string,
  data: FeedbackOptionChild[]
}